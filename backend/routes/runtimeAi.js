  ...
  try {
    ...
    const upstream = await fetch(`${baseUrl}/chat/completions`, {
      ...
      body: JSON.stringify({ model, messages: [
        { role: 'system', content: 'Give concise agricultural operations guidance based only on the supplied non-sensitive facts. State uncertainty and require a qualified human for chemical, safety, or high-impact decisions.' },
