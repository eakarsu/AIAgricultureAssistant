...
// v0 scaffold for: IoT connectivity (Phytos, Indigo Ag, John Deere)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-iot-connectivity-phytos-indigo-ag/run.

export default function IotConnectivityPhytosIndigoAgPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-iot-connectivity-phytos-indigo-ag/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>IoT connectivity (Phytos, Indigo Ag, John Deere)</h1>
