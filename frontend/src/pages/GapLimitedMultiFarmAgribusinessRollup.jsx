...
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-limited-multi-farm-agribusiness-rollup/run.

export default function LimitedMultiFarmAgribusinessRollupPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-multi-farm-agribusiness-rollup/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Limited multi-farm / agribusiness rollup support</h1>
